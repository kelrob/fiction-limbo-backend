            ...
            <div id="content">
                <div class="container">
                    ...
                    <form class="admin-form col-lg-7 ml-5" autocomplete="off" method="POST"
                        action="{{ url('update-process-post') }}">
                        @csrf()
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1"
                                        ...
                                        <option value="{{ $story->type->id }}">{{ $story->type->name }}</option>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1"
                                        ...
                                        <option value="{{ $story->series->id }}">{{ $story->series->title }}</option>
                                        @foreach ($series as $s)
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value={{ $story->user->username }}
                                        id="exampleInputEmail1" name="username" placeholder="Use Writers' Username"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1"
                                        ...
                                        <option value="{{ $story->genre->id }}">{{ $story->genre->title }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $story->tags }}" id="exampleInputEmail1"
                                name="tags" placeholder="love, betrayal, sex, crime" aria-describedby="emailHelp">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">CTA Button Text</label>
                                    <input type="text" name="cta_btn_text" value="{{ $story->cta_btn_text }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cta_btn_link" value="{{ $story->cta_btn_link }}"
                                        class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                            </div>
                        </div>
                        ...
                        <textarea id="mytextarea" name="post">{{ $story->post }}</textarea>

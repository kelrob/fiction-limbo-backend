                ...
                <div class="admin-wrap">
                    <div class="admin-head">
                        <div class="row">
                            <div class="col-lg-6" align="right">
                                <h2><span><a href={{ url('featured-posts') }}>All ({{ $featuredPostCount }})</a></span>
                                    | <span><a class="active-inner" href={{ url('featured-post-draft') }}>Draft
                    ...
                    <div class="admin-body">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($featuredPostDraft as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-action">
                                                ...
                                                <a href="#" onclick="localStorage.setItem('story_id', {{ $post->id }})"
